...
function setup() {
  ...
  invisibleGround = createSprite(200,windowWidth - 200,400,10);
...
function draw() {
  ...
  if(gameState === PLAY){
    ...
    if((touches.length > 0 || keyDown("SPACE")) && trex.y  >= height-280) {
        trex.velocityY = -12;
        jumpSound.play();
             touches = [];
    }
...
function spawnObstacles(){
 if (frameCount % 60 === 0){
   var obstacle = createSprite(600,windowWidth - 210,10,40);
